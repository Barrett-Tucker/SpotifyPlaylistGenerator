...
A simple Python script that takes a specified playlist on Youtube, and generates a Spotify playlist based on the song in your playlist.

## Technologies
* [Youtube Data API v3]
* [Spotify Web API]
* [Requests Library v 2.26.0]
* [Youtube_dl v 2021.06.06]
...
token!  
   ...
   [Requests Library v 2.26.0]: <https://requests.readthedocs.io/en/master/>
